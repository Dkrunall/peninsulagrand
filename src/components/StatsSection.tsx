...
function StatCard({ stat, index }: { stat: typeof STATS[0]; index: number }) {
  ...
  return (
    ...
    >
      ...
      <div className="text-5xl md:text-7xl font-serif text-background tracking-tight leading-none mb-3">
    ...
    <section className="py-20 md:py-32 px-6 md:px-12 bg-foreground relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-12 md:mb-20">
          ...
          <h2 className="text-3xl md:text-6xl font-serif text-background tracking-tighter leading-tight italic">
