...
const ROOMS = [
  {
    title: "Deluxe Room",
    images: ["/rooms/deluxe-room.jpg", "/new/DSC04050.jpg", "/new/DSC04076.jpg"],
    slug: "deluxe-room",
    size: "250 sq.ft.",
    price: 8000,
    bed: "Twin / King Bed",
    ...
    description: "Well-appointed comfort for the always-on-the-move traveller. Laptop-safe, hi-speed WiFi & direct dial.",
    amenities: ["Hi-Speed WiFi", "Laptop Safe", "Tea / Coffee Maker", "Smart Key Card"],
  },
  {
    title: "Executive Room",
    images: ["/rooms/executive-room.jpg", "/new/DSC05913.jpg", "/new/DSC05919.jpg"],
    slug: "executive-room",
    size: "City View",
    price: 9000,
    bed: "Twin / King Bed",
    ...
    description: "Suited for business & leisure. Stunning city views with functional luxury and premium amenities.",
    amenities: ["Hi-Speed WiFi", "Safe Deposit", "Tea / Coffee Maker", "Smart Key Card"],
  },
  {
    title: "Amor Suite",
    images: ["/rooms/amor-suite.jpg", "/new/DSC05983.jpg", "/new/DSC05980.jpg"],
    slug: "amor-suite",
    size: "550 sq.ft.",
    price: 11000,
    bed: "King Bed",
    ...
    description: "550 sq.ft. of indulgent space with a massaging chair, premium bedding & modern connectivity.",
    amenities: ["Massaging Chair", "Hi-Speed WiFi", "Mini Bar", "Smart Key Card"],
  },
  {
    title: "Platinum Suite",
    images: ["/rooms/platinum-suite.jpg", "/new/DSC05961.jpg", "/new/DSC05957.jpg"],
    slug: "platinum-suite",
    size: "700 sq.ft.",
    price: 12000,
    bed: "King Bed",
    ...
    description: "A perfect setting for the jet-set elite. Revive and recharge before your next big moment.",
    amenities: ["Living Area", "Hi-Speed WiFi", "Mini Bar", "Smart Key Card"],
  },
  {
    title: "Presidential Suite",
    images: ["/rooms/presidential-suite.jpg", "/new/DSC05993.jpg", "/new/DSC05998.jpg"],
    ...
    description: "The ultimate abode. In-room bar counter, fully stocked mini bar with international spirits.",
    amenities: ["In-Room Bar", "Mini Bar", "24hr Room Service", "Smart Key Card"],
  },
];
